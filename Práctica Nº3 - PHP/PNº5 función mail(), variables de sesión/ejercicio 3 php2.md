...
- Solicita datos del remitente y del destinatario.
- Permite un mensaje personal opcional.
- El correo se envía al email del amigo con el nombre del remitente.
